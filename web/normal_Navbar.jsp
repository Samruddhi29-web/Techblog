            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item active">
                        <a class="nav-link" href="#"><span class="fa fa-bell"></span>  LearnCode With Sam <span class="sr-only">(current)</span></a>
                    </li>
                ...
                <form class="form-inline my-2 my-lg-0">
                    ...
                    <button class="btn btn-outline-dark primary-background" type="submit">Search</button>
                </form>
            </div>
        </nav>
